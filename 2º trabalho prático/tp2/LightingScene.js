...
LightingScene.prototype.init = function(application) {
    ...
    this.materialIron = new CGFappearance(this);
 	this.materialIron.setAmbient(0.83,0.84,0.85,1);
	this.materialIron.setDiffuse(0.83,0.84,0.85,1);
	this.materialIron.setSpecular(0.8,0.8,0.8,1);
	this.materialIron.setShininess(120);


	this.materialPink = new CGFappearance(this);
	this.materialPink.setAmbient(1.0,0.41,0.71,1);
	this.materialPink.setDiffuse(1.0,0.41,0.71,1);
	this.materialPink.setSpecular(0.9,0.9,0.9,1);
	this.materialPink.setShininess(120);
